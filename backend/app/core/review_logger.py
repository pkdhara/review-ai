    ...
    def log_agent_call(
        ...
        **kwargs: Any,
        ...
        self._write({
            ...
            "targeted_context_chars": kwargs.get("targeted_context_chars", 0),
            "targeted_files": kwargs.get("targeted_files", []),
            "targeted_symbols": kwargs.get("targeted_symbols", []),
            "dependency_triggers": kwargs.get("dependency_triggers", []),
            "dependency_depth": kwargs.get("dependency_depth", 0),
